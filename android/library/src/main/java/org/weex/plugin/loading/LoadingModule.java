package org.weex.plugin.loading;
...
public class LoadingModule extends WXModule {
    ...
    public void show() {
        Log.d(TAG, "Showing!!!");
        Toast.makeText(mWXSDKInstance.getContext(),"Module loading is created sucessfully ",Toast.LENGTH_SHORT).show();
    }
}